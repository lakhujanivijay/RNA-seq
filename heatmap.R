...
pheatmap(mat_data,color=colorRampPalette(c("red","yellow","grey","blue","green"))(60),cluster_row = FALSE,cluster_cols=FALSE,fontsize = 8,cellwidth=30,cellheight=8, cluster_rows = TRUE, display_numbers=F)
dev.off()
